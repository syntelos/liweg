...
public class run {
    ...
    private final static void usage(){
        ...
        System.err.printf("    java -jar liweg.jar run file.libin%n");
        System.exit(1);
    }
        ...
        if (1 == argv.length){
            ...
            if (src.isFile()){
                try {
                    ...
                    System.err.printf("run: error: while reading file %s%n\t",src);
                    exc.printStackTrace();
                    System.exit(1);
                }
            }
            else {
                System.err.printf("run: error: file not found %s%n",src);
                System.exit(1);
            }
        }
        else
